...
public class AppLogger {
     ...
     */
    public static void logOrder(String operation, String orderId, String username, double amount, String status) {
        String message = String.format("Order Operation: %s | OrderID: %s | User: %s | Amount: $%.2f | Status: %s", 
                                       operation, orderId, username, amount, status);
        info("OrderServlet", operation, message);
    }
